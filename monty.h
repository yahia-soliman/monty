...
/**
 * struct stack_s - doubly linked list representats a stack (or queue)
 * @n: integer
...
void stack_op(stack_t **list, unsigned int line_num);
void queue_op(stack_t **list, unsigned int line_num);
